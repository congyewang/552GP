...
# Model Comparison
```{r}
anova(mod.quasi, model.final, test = "Chisq")
```
As a result, there was no significant difference between the two models. We choose the model with stepwise regression.
